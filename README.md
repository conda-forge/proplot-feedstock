...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/proplot-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8765&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/proplot-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `proplot` can be installed with:

```
conda install proplot
```

It is possible to list all of the versions of `proplot` available on your platform with:
